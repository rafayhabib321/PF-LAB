...
void atmSystem(User* user); // Modified to take a user pointer directly
    ...
    do {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                break;
            case 3: {
                // Directly open ATM system after asking for user credentials
                User* user = authenticateUser(users);
                atmSystem(user); // Pass the authenticated user to the ATM system
                break;
            }
            case 4:
